// All tech icons as inline SVG — no external icon library needed
...
export const NodeIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        aria-hidden
    >
        <path d="M11.998 24c-.321 0-.641-.084-.924-.25l-2.937-1.737c-.438-.245-.224-.332-.08-.383.585-.203.703-.25 1.328-.605.065-.037.151-.023.218.017l2.256 1.339c.082.045.197.045.272 0l8.795-5.076c.082-.047.134-.141.134-.238V6.921c0-.099-.053-.19-.137-.242l-8.791-5.072c-.081-.047-.189-.047-.271 0L3.062 6.68c-.085.05-.139.145-.139.243v10.148c0 .097.054.189.137.236l2.409 1.392c1.307.654 2.108-.116 2.108-.891V7.787c0-.142.114-.253.256-.253h1.115c.139 0 .255.111.255.253v10.021c0 1.745-.95 2.745-2.604 2.745-.508 0-.909 0-2.026-.551L2.28 18.675a1.866 1.866 0 01-.927-1.612V6.921a1.87 1.87 0 01.927-1.614L11.076.232a1.936 1.936 0 011.85 0l8.796 5.075a1.87 1.87 0 01.927 1.614v10.142a1.87 1.87 0 01-.927 1.614l-8.796 5.076a1.89 1.89 0 01-.928.247zm2.718-6.975c-3.851 0-4.657-1.769-4.657-3.254 0-.142.114-.253.256-.253h1.136c.127 0 .232.091.252.214.172 1.161.684 1.748 3.014 1.748 1.854 0 2.643-.42 2.643-1.402 0-.566-.224-.987-3.105-1.269-2.409-.237-3.899-.77-3.899-2.697 0-1.778 1.497-2.839 4.006-2.839 2.819 0 4.215.978 4.391 3.081a.257.257 0 01-.065.197.254.254 0 01-.189.083h-1.141a.253.253 0 01-.246-.196c-.274-1.219-.941-1.609-2.75-1.609-2.025 0-2.261.705-2.261 1.234 0 .641.278.827 3.009 1.189 2.705.358 3.991.866 3.991 2.761.001 1.916-1.597 3.012-4.386 3.012z" />
    </svg>
);
...
export const NestJsIcon = ({ className }: { className?: string }) => (
    <svg
        viewBox="0 0 128 128"
        fill="currentColor"
        className={className}
...
export const SocketIoIcon = ({ className }: { className?: string }) => (
    <svg
        viewBox="0 0 128 128"
        fill="currentColor"
        className={className}
...
export const CloudinaryIcon = ({ className }: { className?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const PostgreSQLIcon = ({ className }: { className?: string }) => (
    ...
    >
        <path
            fill="#336791"
            d="M93.6 9.2c-9.5-5.4-22.4-6.7-35.7-3.6-8.6 2-16.9 5.7-24 10.8-6.8 4.9-12.4 11-16.2 17.5-3.9 6.7-5.7 13.7-5.2 20.2.4 5.5 2.5 10.1 6.1 13.4 3.5 3.2 8.2 4.9 13.5 4.9 2.7 0 5.5-.5 8.3-1.5l.5 5.7c.3 4.2 1.9 8.1 4.5 11.1 2.6 3 6.2 5 10.2 5.7 2.4.4 4.8.3 7.2-.3l1.2 7.2c.6 3.8 2.3 7.1 5 9.5 2.6 2.3 6 3.6 9.6 3.6 2.5 0 5-.6 7.2-1.8 4.2-2.2 7.5-6.2 9.2-11.1l3.7-10.8c1.6-4.8 3.1-9.7 4.3-14.7 2.7-11.2 4.1-21.6 4.1-30.9 0-11.7-4.7-20.2-13.5-24.9z"
        />

        <path
            fill="#fff"
            d="M89.4 16.6c6.3 3.6 9.2 9.1 9.2 17.2 0 8.5-1.3 18.2-3.8 28.7-1.2 4.8-2.6 9.6-4.1 14.2L87 87.3c-1.1 3.2-3.1 5.8-5.7 7.2-2.1 1.1-4.4 1.3-6.5.5-2.4-.9-4.1-3.1-4.6-6l-1.8-10.8c-.3-1.8-1.9-3-3.7-2.8-2.4.3-4.7.3-7-.1-2.4-.4-4.6-1.6-6.2-3.4-1.7-2-2.7-4.6-2.9-7.4l-.8-9.7c-.1-1.8-1.9-3.1-3.6-2.5-3.8 1.4-7.5 2.1-10.9 1.8-2.9-.2-5.2-1.3-6.9-2.9-1.8-1.7-2.8-4.2-3.1-7.3-.4-4.7 1.4-9.9 4.4-15.1 3.2-5.5 8.5-11.1 14.5-15.4 6.1-4.4 13.3-7.6 20.8-9.3 11.3-2.6 22-1.7 29.9 2.7z"
        />

        <path
            fill="#336791"
            d="M34.1 33.6c-.6 0-1.2.1-1.8.4-1.8.9-2.6 3.1-1.7 4.9.7 1.4 2.2 2.2 3.7 2 4.3-.6 8.8-.4 13.1.6 1.9.4 3.8-.8 4.2-2.7.4-1.9-.8-3.8-2.7-4.2-4.9-1.2-10-1.5-14.8-1zM72.7 30.9c-1.7.9-2.4 3-1.5 4.7.8 1.7 2.9 2.4 4.6 1.6 3.7-1.7 7.8-2.4 11.8-2.1 1.9.2 3.6-1.2 3.8-3.1.2-1.9-1.2-3.6-3.1-3.8-5.4-.5-10.8.4-15.6 2.7zM48.1 48.8c-1.6-1.1-3.8-.7-4.9.9-1.1 1.6-.7 3.8.9 4.9 5.7 4 12.6 6.1 19.6 5.8 1.9-.1 3.5-1.7 3.4-3.7-.1-1.9-1.7-3.5-3.7-3.4-5.4.2-10.8-1.4-15.3-4.5z"
        />
    </svg>
)
...
export const PrismaIcon = ({ className }: { className?: string }) => (
    ...
    >
        <path
            fill="#2D3748"
            d="M119.2 94.8 76.1 8.2c-1.8-3.7-6.9-4.2-9.4-.9L9.2 89.6c-2.2 3-.1 7.2 3.6 7.2h21.7l18.7 28.9c1.7 2.6 5.1 3.3 7.8 1.8l56.1-29.8c3.1-1.7 4.5-5.4 2.1-9.7z"
        />

        <path
            fill="#fff"
            d="M68.9 18.8 33.4 88.6c-.8 1.6.3 3.5 2.1 3.5h18.8l9.8 24.6c.6 1.5 2.3 2.1 3.7 1.4l42.8-22.7c1.6-.8 2.2-2.7 1.4-4.3L73.7 19c-1-2-3.8-2.1-4.8-.2z"
        />

        <path
            fill="#2D3748"
            d="M55.2 96.2h-15l27.5-68.8 21.8 44.1-34.3 24.7z"
        />
    </svg>
)