          ...
          <div className="relative flex flex-col items-center justify-center">
            ...
            {variant === "full" ? (
              <div className="flex flex-col items-center">
                ...
                <div className="relative mb-8">
                   <HashLoader color="#00c896" size={size} speedMultiplier={1.2} />
                </div>
                ...
                <div className="relative flex flex-col items-center">
                  ...
                  <motion.div 
                    ...
                    className="absolute left-0 w-full h-[2px] bg-primary/70 dark:bg-primary/50 shadow-[0_0_15px_#00eeff] z-20"
                  />
            ...
            {variant === "full" && (
              <div className="absolute inset-[-40px] pointer-events-none">
                <div className="absolute top-0 left-0 w-8 h-[2px] bg-primary/40 dark:bg-primary/30" />
                <div className="absolute top-0 left-0 w-[2px] h-8 bg-primary/40 dark:bg-primary/30" />
                <div className="absolute bottom-0 right-0 w-8 h-[2px] bg-primary/40 dark:bg-primary/30" />
                <div className="absolute bottom-0 right-0 w-[2px] h-8 bg-primary/40 dark:bg-primary/30" />
              </div>
            )}
          </div>
        </motion.div>
