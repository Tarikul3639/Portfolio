...
const Button = ({ text, onClick, variant = "primary", disabled = false, icon, className = "" }) => {
    const variants = {
        ...
        secondary: "inline-flex items-center justify-center whitespace-nowrap duration-300 font-medium ring-offset-background transition-all active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 relative isolation-auto border-2 border-primary before:absolute before:w-full before:transition-all before:duration-500 before:-left-full hover:before:left-0 before:rounded-full before:bg-primary before:-z-10 before:aspect-square hover:before:scale-150 overflow-hidden hover:text-primary-foreground focus:before:left-0 focus:before:scale-150 focus:text-primary-foreground h-11 px-8",
