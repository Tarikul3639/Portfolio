    ...
    return (
        <nav className={`fixed top-0 left-0 w-full z-[999] transition-all duration-500 ${
            ...
            <div className={`mx-auto px-6 transition-all duration-700 ease-in-out ${
                scrolled 
                ? "max-w-4xl bg-white/80 dark:bg-black/60 backdrop-blur-xl border border-neutral-200/50 dark:border-white/10 rounded-full shadow-xl dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)]" 
                ...
                <div className="flex items-center justify-between h-14">
                    ...
                    <Link to="home" smooth={true} className="cursor-pointer group flex items-center gap-2">
                        ...
                        <h1 className="text-xl font-black tracking-tighter uppercase text-neutral-900 dark:text-white">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.9 }}
                            onClick={toggleTheme} 
                            className="relative w-10 h-10 rounded-full bg-neutral-100/70 dark:bg-white/5 border border-neutral-200/40 dark:border-white/10 flex items-center justify-center overflow-hidden group shadow-sm"
                        >
                    ...
                    {/* MOBILE MENU BUTTON */}
                    <button className="md:hidden text-primary p-2 shadow-sm hover:shadow-md transition-shadow" onClick={() => setIsOpen(true)}>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div 
                            ...
                            className="fixed inset-0 bg-neutral-900/90 dark:bg-black/90 backdrop-blur-md z-[1000]"
                        />
                        ...
                        <motion.div 
                            ...
                            className="fixed top-0 right-0 h-full w-[300px] bg-white/95 dark:bg-[#050505] border-l border-neutral-200/50 dark:border-primary/20 z-[1001] p-10 flex flex-col shadow-[-20px_0_60px_rgba(0,0,0,0.1)] dark:shadow-[-20px_0_60px_rgba(0,238,255,0.1)] backdrop-blur-xl"
                        >
                            {/* CLOSE BUTTON */}
                            <button
                                onClick={() => setIsOpen(false)}
                                className="self-end text-primary mb-12 hover:rotate-90 transition-transform duration-300 hover:scale-110"
                            >
                                ...
                                {menuItems.map((item, i) => (
                                        ...
                                        >
                                            <Link
                                                ...
                                                smooth={true}
                                                onClick={() => setIsOpen(false)}
                                                className="text-3xl font-black uppercase tracking-tighter text-neutral-700 dark:text-neutral-600 hover:text-primary transition-all flex items-center gap-4 group shadow-sm rounded-lg p-3 hover:shadow-md hover:shadow-primary/10"
                                            >
                                                <span className="text-xs font-mono text-primary/50 dark:text-primary/30 group-hover:text-primary">
                                                    0{i + 1} //
                                                </span>
                                                {item}
                                            </Link>
                            ...
                            {/* MOBILE THEME SWITCH */}
                            <div className="mt-auto pt-10 border-t border-neutral-200/30 dark:border-white/5">
                                <motion.button 
                                    onClick={toggleTheme}
                                    className="w-full py-4 rounded-xl bg-neutral-100/80 dark:bg-primary/5 border border-neutral-200/40 dark:border-primary/20 flex items-center justify-center gap-3 text-neutral-900 dark:text-primary font-bold uppercase text-xs tracking-widest shadow-sm hover:shadow-md hover:shadow-primary/10 transition-all"
                                >
                                    <FontAwesomeIcon icon={theme === "dark" ? faSun : faMoon} />
